...
<form action="addPatient">
 <h1 id="litheader">Patient List</h1>

 <p class="p-container">

      <input type="submit" name="Submit" id="go" value="New Patient" >
...
<table id="example" class="display" style="width:100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>${patients.registrationNo}</td>
                <td><a href="<c:url value='PatientDetails/${patients.registrationNo}'/>">${patients.patientName}</a></td>
                <td></td>
                <td></td>
                <td></td>
                <td></td>
           ...
           <!--  <tr>
                <td>Tiger Nixon</td>
                <td><a href="PatientDetails">Priyanka Adamuthe</a></td>
                <td>Edinburgh</td>
                <td>61</td>
                <td>2011/04/25</td>
                <td>$320,800</td>
