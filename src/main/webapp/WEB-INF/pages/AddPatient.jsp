...
<div class="background-wrap">
  ...
  <form id="accesspanel" onsubmit="submit()" action="Patients/fromNewPatients"  method="post"  modelAttribute="patients" >
    <h1 id="litheader">Add Patient</h1>
    <div class="inset">
    <input type = "hidden" value = "${msg }" id="msg" name = "msg"> 
      <p>
        <input type="text" name="regiNo" id="regiNo"   placeholder="Registration number">
      </p>
      <p>
...
if((document.getElementById('msg').value ) == "Patient name or registration no already exist" || (document.getElementById('msg').value ) == ""){
	console.log("equals..");
	alert("Patient name or registration no already exist");
}
 else{
