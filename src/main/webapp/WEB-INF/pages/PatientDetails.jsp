...
<div class="background-wrap">
  ...
  <form id="accesspanel" onsubmit="submit()" action="Patients/details"  method="post" >
    <h1 id="litheader">Add Patient Details</h1>
    
    <div class="inset">
     <p>
     
        <input type="text" name="regino" id="regino"   value="${patients.registrationNo} " readonly="true">
      </p>
     <p>
        <input type="text" name="patientName" id="pname"  value="${patients.patientName} " readonly="true">
      </p> 
     
      <p>
        <input type="text" name="opd"   id="opd" placeholder="OPD">
      </p>
      <p>
        <textarea rows="4" cols="50" placeholder="complaint" name="complaint"></textarea>
      </p>
      <p>
        <textarea rows="4" cols="50" placeholder="complaint analysis" name="complaintAnalysys" ></textarea>
      </p>
